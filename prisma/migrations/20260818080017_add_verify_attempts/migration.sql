...
INSERT INTO "new_VerifyCode" ("code", "createdAt", "expiresAt", "id", "target", "type", "usedAt", "userId") SELECT "code", "createdAt", "expiresAt", "id", "target", "type", "usedAt", "userId" FROM "VerifyCode";
